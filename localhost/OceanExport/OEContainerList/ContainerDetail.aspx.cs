...
public partial class OceanExport_OEContainerList_ContainerDetail : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        DataFactory dal = new DataFactory();
        bool b = dal.FactoryDAL(PageHelper.ConnectionStrings, "FW_OceanExport_Container_SP", new List<IFields>() { dal.CreateIFields().Append("Option", "DesUpdate")
    ...
    {
        DataFactory dal = new DataFactory();
        bool b = dal.FactoryDAL(PageHelper.ConnectionStrings, "FW_OceanExport_Container_SP", new List<IFields>() { dal.CreateIFields().Append("Option", "DesDelete")
