<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CntrAndSeal.aspx.cs" Inherits="OceanExport_OEContainerList_CntrAndSeal" %>
                    ...
                    <ext:GridPanel ID="gridList" runat="server" Height="325px" TrackMouseOver="true"  TabIndex="7"
                        ...
                        <ColumnModel runat="server" ID="ColumnModel1">
                            <Columns>
                                ...
                                <ext:Column Header="HBL" DataIndex="o_HBL" Width="90">
                                </ext:Column>
                                <ext:Column Header="Container#" DataIndex="oc_CtnrNo" Width="100">
                                </ext:Column>
                                <ext:Column Header="Seal#" DataIndex="oc_SealNo" Width="80" >
                                </ext:Column>
                                 <ext:Column Header="Size" DataIndex="oc_CtnrSize" Width="60" >
                                </ext:Column>
                                <ext:Column Header="S/O#" DataIndex="oc_SONo" Width="80" >
                                </ext:Column>
                                 <ext:NumberColumn Header="WT" DataIndex="oc_GWT" Width="60" Format="0.000" Align="Right">
                                </ext:NumberColumn>
                                <ext:NumberColumn Header="CBM" DataIndex="oc_CBM" Width="72" Format="0.000" Align="Right">
                                </ext:NumberColumn>
                                <ext:NumberColumn Header="PKGS" DataIndex="oc_Piece" Width="55" Format="0" Align="Right">
                                </ext:NumberColumn>
                            </Columns>
                        </ColumnModel>
                        <SelectionModel>
