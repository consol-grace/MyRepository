...
<body>
    ...
    <table border="0" cellspacing="4" cellpadding="0" style="padding-left: 10px">
        <tr>
            ...
            <td>
                <ext:TextField ID="txtMBL" runat="server" Width="90" TabIndex="3"  Cls="text">
                </ext:TextField>
            </td>
        ...
        <tr>
            ...
            <td width="90">
                <div id="divDest" runat="server">
                    <uc1:UserComboBox runat="server" ID="cmbDest" ListWidth="180" clsClass="select_160px"
                        TabIndex="5" Query="option=LocationList&sys=O" StoreID="StoreLocation" Width="90"
            ...
            <td width="90">
                ...
                <div id="divSalesman" runat="server">
                    <uc1:UserComboBox runat="server" ID="cmbSalesman" Query="option=SalesList" Width="90"
                        ...
                        TabIndex="6" winWidth="680" winHeight="560" isButton="false" />
                </div>
            </td>
            <td style="padding-left:10px">
            ...
            <td>
                <ext:TextField ID="txtHBL" runat="server" Width="90" TabIndex="7"  Cls="text">
                </ext:TextField>
            </td>
            <td width="50" style="padding-left: 10px">
            ...
            <td>
                <uc1:AutoComplete runat="server" ID="cmbConsigneeCode" TabIndex="8" clsClass="x-form-text x-form-field text"
                    Query="option=CompanyList" Width="100" winTitle="Company" winUrl="/BasicData/Customer/detail.aspx"
                    winWidth="800" winHeight="800" isDiplay="false" />
            </td>
           <td></td><td></td>
        ...
        <tr>
            ...
            <td>
                <ext:TextField ID="txtJobNo" runat="server" Width="90" TabIndex="9"  Cls="text">
                </ext:TextField>
            </td>
            <td width="40" style="padding-left: 10px">
                Vessel
            ...
            <td>
                <ext:TextField ID="txtVessel" runat="server" Width="90" TabIndex="10"  Cls="text">
                </ext:TextField>
            </td>
            <td width="40" style="padding-left: 10px">
                Voyage
            ...
            <td>
                <ext:TextField ID="txtVoyage" runat="server" Width="90" TabIndex="11"  Cls="text">
                </ext:TextField>
            </td>
            <td width="40" style="padding-left: 10px">
                Container
            ...
            <td>
                <ext:TextField ID="txtContainer" runat="server" Width="127" TabIndex="12"  Cls="text">
                </ext:TextField>
            </td>
            <td  width="50" ></td>
    ...
    <div id="div1" runat="server" style="padding-left: 10px">
        <iframe id="mainReference" height="550px" width="930px" scrolling="yes" src="<%=href() %>"
