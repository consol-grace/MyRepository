<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportFile1.aspx.cs" Inherits="OceanExport_OEReportFile_ReportFile" %>
...
<body>
   <form id="form1" runat="server">
    ...
    <td><ext:Label ID="lbltishi" runat="server"></ext:Label></td>
    <td><ext:Button ID="btnPrint" runat="server" Text="HBL" Cls="font_11px_bold2" Width="60px"
                                        ...
                                        <td><ext:Button ID="btnDraft" runat="server" Text="Draft" Cls="font_11px_bold2" Width="60px"
                                            StyleSpec="margin:0px 2px;">
                                            <DirectEvents>
                                        ...
                                        </ext:Button></td><td><ext:Button ID="btnACI" runat="server" Text="ACI" Cls="font_11px_bold2" Width="60px"
                                            StyleSpec="margin:0px 2px;">
                                            <DirectEvents>
               ...
               <td>
               <ext:Button ID="btnAttachList" runat="server" Text="Attach" Cls="font_11px_bold2" Width="60px"
                                            StyleSpec="margin:0px 2px;">
                                            <DirectEvents>
    ...
    <td style="padding-left:2px; padding-right:0px;width:45px;display:block;">
                        <ext:ComboBox ID="cmbPrintCount" runat="server" Width="40px" SelectedIndex="0" ListWidth="40px" Mode="Local" TriggerAction="All" DisplayField="text" ValueField="value">
                        <Store>
 ...
 <td width="40px" style="padding-left:5px;">
  ...
  <td width="40px" style="padding-left:5px;display:block;">
   <ext:Button ID="LinBtnPDF" runat="server"  Text="Export" Width="65" AutoFocus="true"  AutoShow="true" Selectable="true" >
    ...
    <tr><td style="border:solid 1px #000;text-align:center;" >
