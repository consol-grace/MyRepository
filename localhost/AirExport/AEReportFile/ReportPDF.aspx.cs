...
public partial class AirExport_AEReportFile_ReportPDF : System.Web.UI.Page
{
    ...
    protected void btnInvDraft_Click(object sender, EventArgs e)
    {
        ...
        Session["Tishi"] = hidID.Text;
        lbltishi.Text = "Printed on  " + DateTime.Now.ToString("dd/MM/yyyy HH:mm").Replace("-", "/");
        ControlBinder.PrintLog(FSecurityHelper.CurrentUserDataGET()[0], FSecurityHelper.CurrentUserDataGET()[12], "AE", hidtype.Text + "(ID:" + hidID.Text + ")", CmbPrint1.Text);
    }
