<%@ Page Language="C#" AutoEventWireup="true" CodeFile="update.aspx.cs" Inherits="Framework_Permission_update" Theme="FORM" %>
        ...
        <div class="mypanel">
            <table id="table-company-update" cellpadding="0" cellspacing="0" border="0">
                <tr>
                    <th>权限编号</th>
                    <td>
                        <input type="text" runat="server" id="PermissionID" name="PermissionID" />&nbsp;<font color="red">* 例: P01</font>
                    </td>
                </tr>
                <tr>                    
                    <th>姓名</th>
                ...
                <tr>                    
                    <th>昵称</th>
                    <td>
                        <input type="text"  runat="server" id="NameENG" name="NameENG" />&nbsp;<font color="red">*</font>
                    </td>                    
                </tr>
                <tr>                    
                    <th>备注</th>
