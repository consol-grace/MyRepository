/// <reference path="jQuery/js/jquery-1.4.1.js" />
/// <reference path="jQuery/js/jquery.ui.custom.js" />
...
(function(myplugin) {
    ...
    var _Dialog = function() {
        ...
        myplugin.Utility.Dialog.Close();
            ...
            html += '       <div id="div_window_title"><div id="div_window_button" onclick=\'myplugin.Utility.Dialog.Close()\'></div>{Caption}</div>';
            html += '       <div id="div_window02"><div id="div_window03">';
            html += '   <div style="width: ' + opts.width + '; height: ' + ifmHeight + '">';
            html += '       {html}';
            html += "   </div>";
