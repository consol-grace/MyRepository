...
Ext.onReady(function(){
    ...
    var grid2 = new xg.GridPanel({
        ...
        cm: new xg.ColumnModel({
            ...
            columns: [   
                {id:'#',header: "#", width: 19, dataIndex: ''},  
                {header: "Kind", width:90,dataIndex: 'Kind'},       
                {header: "Company", width:250,dataIndex: ''},
                {header: "Dest.",width:90, dataIndex: 'Dest'}, 
                {header: "Voyage", width:90,dataIndex: 'Voyage'},  
                {header: "ETD", width:90,dataIndex: 'ETD'},
                {header: "ETA", width:90,dataIndex: 'ETA'}
