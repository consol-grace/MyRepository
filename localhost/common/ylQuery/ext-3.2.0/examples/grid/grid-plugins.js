    ...
    var grid2 = new xg.GridPanel({
        ...
        cm: new xg.ColumnModel({
            ...
            columns: [
                ...
                {header: "Price", width:60, renderer: Ext.util.Format.usMoney, dataIndex: 'price'},
                {header: "Change",width:60, dataIndex: 'change'},
                {header: "% Change", width:60,dataIndex: 'pctChange'},
				{header: "Change",width:60, dataIndex: 'change'},
                {header: "% Change", width:60,dataIndex: 'pctChange'},
				{header: "Change",width:60, dataIndex: 'change'},
                {header: "% Change", width:60,dataIndex: 'pctChange'},
				{header: "Change",width:60, dataIndex: 'change'},
                {header: "% Change", width:60,dataIndex: 'pctChange'},
                {header: "Last Updated", width: 60, renderer: Ext.util.Format.dateRenderer('m/d/Y'), dataIndex: 'lastChange'}
            ]
        }),
        sm: sm,
        columnLines: true,
