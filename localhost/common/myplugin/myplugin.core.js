    ...
    */
    var Controller = function(opts, callback) {
        ...
        if (opts.form) {
            ...
            jQuery.ajax({ type: 'POST', url: opts.url, data: jQuery("#form" + tmpId).serialize() + checkbox,
