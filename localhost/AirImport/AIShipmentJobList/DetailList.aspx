...
<body>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td width="348" align="right" valign="top" style="padding-right: 5px; padding-bottom: 2px; padding-top:4px;"
                                        ...
                                        <nobr>
                                                <span runat="server" id="txtDirect" style="margin-right:15px;"><input type="checkbox" id="chkDirect" disabled="disabled" checked="checked" style="background-color:Transparent; vertical-align:text-bottom; border:solid 1px #ddd;" /><span style="font-weight:bold; color:Red; margin-left:5px;">Direct</span></span>
                                                Lot#&nbsp;<label id="txtLotNo" runat="server"></label>
                                                &nbsp;&nbsp;&nbsp;MAWB#&nbsp;<label id="txtMawb" runat="server"></label></nobr>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
    ...
    <div id="win_close" style="background-color: Transparent; padding: 5px 15px; display: none;
        ...
        <div id="NewInvoice" style="width: 320px; margin-top: 15px;padding-bottom:10px; background: #fff;
            border: outset 2px #fff; padding: 10px;">
               ...
               <%if (Convert.ToBoolean(DIYGENS.COM.FRAMEWORK.FSecurityHelper.CurrentUserDataGET()[26]))
                ...
                <tr>
                    ...
                    <td style="vertical-align: middle; line-height: 25px;">
                       <input type="checkbox" id="chkChina"  tabindex="45"  style="vertical-align:middle; margin-right:5px;"/> Show Chinese
                    </td>
                </tr>
                <%} %>
                ...
                <tr>
                    ...
                    <td>
                        <input onclick="NewInvoice('AI','txtCompany',cmbCurrency,StoreCurrInvoice);" type="button"
                            style="background-image: url(../../images/btn_save_01.jpg); border: 0px; margin-bottom:12px; width: 82px;
                            height: 22px; cursor: pointer" class="btn_text" tabindex="45" value="New Invoice" />
                    </td>
                </tr>
            </table>
        </div>
    </div>
    <div id="div_sheet" style="position: absolute; z-index: 3; top: 100px; left: 250px;background-color:#fff;padding:15px; display:none; border:outset 2px #ddd">
        <img id="win_close_sheet" src="../../images/btn_close.png" style="position: absolute;
            right: -20px; top: -20px; width: 33px; height: 33px; cursor: pointer;" />        <uc2:UserSheet ID="UserSheet1" runat="server" />
    </div>
    </form>
</body>
</html>
