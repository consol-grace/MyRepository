<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportPDF.aspx.cs" Inherits="OceanImport_OceanShipmentJobList_ReportPDF" %>
...
<body>
    ...
    <asp:HiddenField ID="hidsys" runat="server" Value="OI" />
                ...
                <div style="width: 1000px; margin: 0px auto; text-align: right">
                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                        <tr>
                            ...
                            <td style="font-weight: bold; padding: 0 8px; text-align: right; display: block;">
                                Copies
                            </td>
