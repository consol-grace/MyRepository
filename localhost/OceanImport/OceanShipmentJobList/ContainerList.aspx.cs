...
public partial class OceanImport_OceanShipmentJobList_ContainerList : System.Web.UI.Page
{
    ...
    protected void btnAssign_Click(object sender, DirectEventArgs e)
    {
        ...
        {
            DataFactory dal = new DataFactory();
            dal.FactoryDAL(PageHelper.ConnectionStrings, "FW_OceanImport_Container_SP", new List<IFields>() { dal.CreateIFields()
