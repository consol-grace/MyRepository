...
public class DataController : DIYGENS.COM.BASECLASS.ControllerBase
{
    ...
    private void list()
    {
        DataTable dt = this.FactoryDAL(PageHelper.ConnectionStrings, "FW_BasicData_Unit_SP", new List<IFields>() { this.CreateIFields().Append("Option", "List")
    ...
    private void update()
    {
        bool bFlag = this.FactoryDAL(PageHelper.ConnectionStrings, "FW_BasicData_Unit_SP", new List<IFields>() { this.CreateIFields().Append("Option", "Update")
                ...
                .Append("Short",Request.Form["Short"].Trim())
