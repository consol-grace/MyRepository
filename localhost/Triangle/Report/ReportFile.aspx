<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportFile.aspx.cs" Inherits="Triangle_Report_ReportFile" %>
...
<td width="56px"  align="center" id="showDraft" runat="server" visible="false">
 ...
 <td width="40px"><ext:Button ID="LinBtnPrint" runat="server"  Text="Print" Width="65"  >
                          <DirectEvents>
