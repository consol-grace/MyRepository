                    ...
                    <tr>
                        <td align="left" background="../../images/bg_line.jpg" bgcolor="#FFFFFF">
                            <table width="100%">
                                <tbody>
                                    <tr>
                                        <td width="180px" align="left" style="padding-left: 5px" class="font_11bold_1542af">
                                            Tran. Shipment-Detail List
                                        </td>
                                        ...
                                        <td width="348" align="right" valign="top" style="padding-right: 5px; padding-bottom: 2px;
                                            padding-top: 4px;" class="font_11bold_1542af">
                                            <nobr>Lot#&nbsp;<label id="txtLotNo" runat="server"></label>&nbsp;&nbsp;&nbsp;MBL/MAWB#&nbsp;<label id="txtMawb" runat="server"></label>  </nobr>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
            ...
            <div id="NewInvoice" style="width: 320px; margin-top: 15px; padding-bottom: 10px;
                ...
                <table cellpadding="0" cellspacing="0" border="0" width="100%" class="tab_Invoice">
                    ...
                    <tr>
                        ...
                        <td>
                            <input onclick="NewInvoice('<%=(Request["sys"]=="A"?"AT":"OT") %>','txtCompany',cmbCurrency,StoreCurrInvoice);"
