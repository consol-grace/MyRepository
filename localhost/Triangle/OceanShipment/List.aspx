...
<head id="Head1" runat="server">
    ...
    <script src="../TriJs/triOcean.js" type="text/javascript"></script>
...
<body>
    ...
    <div id="div_title" style="margin-left: 10px; margin-top: 80px; z-index: 990">
        <table width="979" border="0" cellspacing="0" cellpadding="0" class="table_nav1 font_11bold_1542af">
            <tr>
                        ...
                        <tr>
                            <td>
                                <img src="/images/arrows_btn.png" id="img_showlist" style="cursor: pointer; vertical-align: middle"
                                    alt="View" onclick="createFrom('OT');" />&nbsp;
                            </td>
                            <td>
                                Triangle Shipment (Ocean)
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <%if (!string.IsNullOrEmpty(Request["seed"]))
                                  { %>
                                <uc1:Transfer runat="server" ID="TransferSys" sys="OT" />
                                <%} %>
                            </td>
                        </tr>
                    </table>
    ...
    <div id="mawb_div" runat="server" style="margin-bottom: 30px; margin-top: 70px">
                        ...
                        <tr style="height: 24px">
                            ...
                            <td align="left">
                                <ext:TextField ID="txtHAWB" runat="server" Cls="text_110px" Width="103" TabIndex="2">
                                    <Listeners>
                                        <Blur Handler="CheckHBLNo(this,'OT',hidSeed.getValue())" />
                                    </Listeners>
                                </ext:TextField>
                            </td>
        ...
        <table id="table1" width="800px" border="0" cellpadding="0" cellspacing="0" style="padding-top: 15px">
            ...
            <tr id="grid3">
                ...
                <td valign="top" style="padding-left: 5px;">
                    ...
                    <td style="padding-left: 15px;">
                        <ext:TextArea ID="txtMAWBRemark" runat="server" Width="260" Height="80" Cls="text_80px" TabIndex="15">
                        </ext:TextArea>
                    </td>
                    </tr>
                    </table>
            ...
            <tr>
                <td colspan="2">
                    <uc1:Costing ID="ucCost" runat="server" type="M" sys="OT" />
                </td>
            </tr>
            <tr>
