...
<head id="Head1" runat="server">
    ...
    <script src="../OtherJs/DM.js" type="text/javascript"></script>
                        ...
                        <tr>
                            <td>
                                <img src="/images/arrows_btn.png" id="img_showlist" style="cursor: pointer; vertical-align: middle"
                                    alt="View" onclick="createFrom('DM');" />&nbsp;
                            </td>
                            <td>
                                Domestic Shipment
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <%if (!string.IsNullOrEmpty(Request["seed"]))
                                  { %>
                                <uc1:Transfer runat="server" ID="TransferSys" sys="DM" />
                                <%} %>
                            </td>
                        </tr>
                    </table>
                ...
                <td align="left" valign="top" style="padding-top: 38px; padding-left: 6px; width: 624px">
                    <table width="624px" border="0" cellpadding="0" cellspacing="0" style="margin-top: 8px;">
                        <tr style="height: 24px">
                            ...
                            <td align="left">
                                <ext:TextField ID="txtHAWB" runat="server" Cls="text_110px" Width="103" TabIndex="2">
                                    <Listeners>
                                        <Blur Handler="CheckHBLNo(this,'DM',hidSeed.getValue())" />
                                    </Listeners>
                                </ext:TextField>
                            </td>
                        ...
                        <tr style="height: 24px">
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0" border="0" width="79">
                                    <tr>
                                        <td class="font_11bold" style="padding-left: 15px; padding-right: 2px;">
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0" border="0" width="71">
                                    <tr>
                                        <td class="font_11bold" style="padding: 0 13px; text-align: left;">
                                            ETA
                                        </td>
                                    </tr>
                                </table>
        ...
        <table id="table1" width="800px" border="0" cellpadding="0" cellspacing="0" style="padding-top: 8px">
            ...
            <tr id="grid3">
                ...
                <td valign="top" style="padding-left: 5px;">
                     ...
                     <tr>
                    <td width="60" align="left" class="font_11bold" style="padding-left: 2px;" valign="top">
                        Remark
                    </td>
                    <td style="padding-left: 15px;">
                        <ext:TextArea ID="txtMAWBRemark" runat="server" Width="262" Height="80" Cls="text_80px" TabIndex="15">
                        </ext:TextArea>
                    </td>
                    </tr>
                    </table>
            ...
            <tr>
                <td colspan="2">
                    <uc1:Costing ID="ucCost" runat="server" type="M" sys="DM" />
                </td>
            </tr>
            <tr>
