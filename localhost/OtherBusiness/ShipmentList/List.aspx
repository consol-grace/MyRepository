...
<head id="Head1" runat="server">
    <title>Other Business List</title>
                ...
                <td>
                        ...
                        <tr> 
                           <%-- <td style="padding-left: 10px" align="left">
                            ...
                            <td width="100" align="left">
                                <ext:TextField ID="txtCNEE" runat="server" Cls="text_100px" Width="120" TabIndex="3">
                                </ext:TextField>
                            </td>--%>
                    ...
                    <td width="105" align="right">
                        ...
                        <tr>
                            ...
                            <td width="100" align="left">
                                <ext:TextField ID="txtShipper" runat="server" Cls="text_100px" Width="120" TabIndex="4">
                                </ext:TextField>
                            </td>
                            <td style="padding-left: 10px" align="left">
                                From
                            ...
                            <td colspan="2" align="left" style="padding-top: 8px; padding-bottom: 5px; padding-left: 5px;
                                ...
                                <span style="float: right; margin: 0px 0px 0px 25px">
                                    <ext:Button ID="btnPrint" runat="server" Cls="Submit lotprint" Text="Print" Width="50"
                                        TabIndex="8" AutoFocus="true" AutoShow="true" Selectable="true">
                                        <DirectEvents>
                    ...
                    <td colspan="5"></td>
                    <td width="52" align="right" style="padding-right:5px;">
                             ...
                             <td colspan="2" align="left" style="padding-top: 8px; padding-bottom: 5px; padding-left: 5px;
                                ...
                                <span style="float: right; margin: 0px 0px 0px 25px">
                                    <ext:Button ID="btnPrint" runat="server" Cls="Submit lotprint" Text="Print" Width="50"
                                        TabIndex="9" AutoFocus="true" AutoShow="true" Selectable="true">
                                        <DirectEvents>
                                            <Click OnEvent="btnPrint_Click">
                                            </Click>
                                        </DirectEvents>
                ...
                <td colspan="5" id="GridView">
                    <ext:GridPanel ID="gridList" runat="server" Height="368" TrackMouseOver="true" TabIndex="14"
                        ...
                        <ColumnModel runat="server" ID="ColumnModel1">
                            <Columns>
                                <ext:Column Header="Type" DataIndex="Type" Width="68" Align="Center">
                                </ext:Column>
                                <ext:Column Header="MBL" DataIndex="tri_MBL" Width="85">
                                </ext:Column>
                                <ext:Column Header="HBL" DataIndex="tri_HBL" Width="90">
                                </ext:Column>
                                <ext:Column Header="Lot#" DataIndex="tri_LotNo" Width="145">
                                </ext:Column>
                                <ext:Column Header="Shipper" DataIndex="tri_ShipperLine" Width="125">
                                </ext:Column>
                                <ext:Column Header="Consignee" DataIndex="tri_ConsigneeLine" Width="25">
                                </ext:Column>
                                ...
                                <ext:Column Header="Depart." DataIndex="tri_LocReceived" Width="55" Align="Center">
                                </ext:Column>
                                <ext:Column Header="Dest." DataIndex="tri_LocFinal" Width="50" Align="Center">
                                </ext:Column>
