...
<body>
    ...
    <div id="div_title" style="margin-left: 10px; margin-top: 80px; z-index: 990;">
        <table width="975" border="0" cellspacing="0" cellpadding="0" class="table_nav1 font_11bold_1542af">
            <tr>
                        ...
                        <tr>
                            <td>
                                <img src="/images/arrows_btn.png" id="img_showlist" style="cursor: pointer; vertical-align: middle"
                                    alt="View" onclick="createFrom('BK');" />&nbsp;
                            </td>
                            <td>
                                Brokerage Shipment
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <%if (!string.IsNullOrEmpty(Request["seed"]))
                                  { %>
                                <uc1:Transfer runat="server" ID="TransferSys" sys="BK" />
                                <%} %>
                            </td>
                        </tr>
                    </table>
    ...
    <div id="mawb_div" runat="server" style="margin-bottom: 30px; margin-top: 70px">
                            ...
                            <td align="left" bgcolor="#FFFFFF" style="padding-left: 2px">
                                ...
                                <td align="center" bgcolor="#FFFFFF" style="padding-left: 2px; padding-right: 2px">
                                    <uc1:UserComboBox runat="server" ID="CmbUnit" ListWidth="180" clsClass="select_160px"
                                        StoreID="StoreUnit" Width="67" winTitle="Unit" TabIndex="19" winUrl="/BasicData/Unit/list.aspx?sys=O"
                            ...
                            <td align="center" bgcolor="#FFFFFF">
                                ...
                                <td align="center" bgcolor="#FFFFFF">
                                    <ext:NumberField ID="txtContainer" runat="server" Cls="text" AllowDecimals="false"
                                        StyleSpec="text-align:right" TabIndex="19" Width="88">
                                    </ext:NumberField>
                                </td>
                        </tr>
                    </table>
                ...
                <td align="left" valign="top" style="padding-top: 38px; padding-left: 6px; width: 624px">
                    <table width="624px" border="0" cellpadding="0" cellspacing="0" style="margin-top: 8px;">
                        <tr style="height: 24px">
                            ...
                            <td align="left" style="width: 44px; text-align: left; padding-left: 5px; padding-right: 2px">
                                House
                            </td>
                            <td align="left">
                                <ext:TextField ID="txtHAWB" runat="server" Cls="text_110px" Width="103" TabIndex="2">
                                    <Listeners>
                                        <Blur Handler="CheckHBLNo(this,'BK',hidSeed.getValue())" />
                                    </Listeners>
                                </ext:TextField>
                            </td>
                            <td class="font_11bold" style="padding-left: 15px; padding-right: 2px;">
                            ...
                            <td class="font_11bold" style="padding: 0 5px; text-align: center;">
                                <nobr>Job Date</nobr>
                            </td>
                            <td align="left">
                                <ext:DateField ID="txtJob" runat="server" Cls="text" Width="90" Format="d/m/Y" TabIndex="4">
                                </ext:DateField>
                            </td>
                        </tr>
                        <tr style="height: 24px">
                            ...
                            <td align="left" colspan="2" style="padding-left: 4px; padding-bottom: 1px">
                                <ext:TextField ID="CmbShipperCode_name" runat="server" Cls="text_82px" Width="150px"
                                    TabIndex="5">
                                </ext:TextField>
                                <ext:Hidden ID="CmbShipperCode1" runat="server">
                                </ext:Hidden>
                            </td>
                            <td align="left" class="font_11bold" style="padding-left: 15px">
                                Carrier
                            </td>
                            <td align="left">
                                <table border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td>
                                            <uc1:Autocomplete runat="server" ID="CmbCarrierCode" clsClass="input text_82px" TabIndex="9"
                            ...
                            <td align="left" colspan="2" style="padding-left: 4px; padding-bottom: 1px">
                                <ext:TextField ID="CmbCarrierCode_name" runat="server" Cls="text_82px" Width="161"
                                    TabIndex="9">
                                </ext:TextField>
                        ...
                        <tr style="height: 24px">
                            ...
                            <td align="left" colspan="2" style="padding-left: 4px; padding-bottom: 1px">
                                <ext:TextField ID="CmbConsigneeCode_name" runat="server" Cls="text_82px" Width="150px"
                                    TabIndex="6">
                                </ext:TextField>
                            ...
                            <td colspan="3" align="left" valign="top" style="padding-top: 3px">
                                <table border="0" cellpadding="0" cellspacing="0">
                                    <tbody>
                                        <tr>
                                            <td>
                                                <ext:ComboBox ID="cmbVesselCode" runat="server" Cls="select" Width="136" StoreID="StoreVessel"
                                                    DisplayField="text" TabIndex="10" ValueField="value" Mode="Local" ForceSelection="false"
                                            ...
                                            <td>
                                                <ext:ComboBox ID="cmbVesselText" runat="server" Cls="select" Width="96" StoreID="StoreVoyage"
                                                    Editable="true" TabIndex="10" DisplayField="text" ValueField="value" Mode="Local"
                                                    ForceSelection="false" TriggerAction="All" ItemSelector="tr.list-item" ListWidth="130px">
                                                </ext:ComboBox>
                                            </td>
                        ...
                        <tr style="height: 24px">
                            ...
                            <td align="left" colspan="2" style="padding-left: 4px; padding-bottom: 1px">
                                <ext:TextField ID="CmbNotify1Code_name" runat="server" Cls="text_82px" Width="150px"
                                    TabIndex="7">
                                </ext:TextField>
                            ...
                            <td align="left">
                                <uc1:UserComboBox runat="server" ID="CmbDeparture" ListWidth="180" clsClass="select_160px"
                                    TabIndex="11" StoreID="StoreLocation" Width="69" winTitle="Location" winUrl="/BasicData/Location/list.aspx?sys=O"
                                    winWidth="845" winHeight="620" Handler="SelectItem('CmbDeparture','txtDepL')" />
                            </td>
                            <td class="font_11bold" style="padding: 0 5px; text-align: left;" colspan="2">
                                <ext:TextField ID="txtDepL" runat="server" Cls="text_82px" Width="160" TabIndex="11">
                                </ext:TextField>
                            </td>
                        </tr>
                        <tr style="height: 24px">
                            ...
                            <td align="left">
                                <table border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td>
                                            <uc1:Autocomplete runat="server" ID="CmbNotify2Code" Query="option=CompanyList" TabIndex="7"
                                                Width="61" clsClass="text_82px" winTitle="Company" winUrl="/BasicData/Customer/detail.aspx"
                                                winWidth="800" winHeight="800" isDiplay="false" />
                                        </td>
                                    </tr>
                            ...
                            <td align="left" colspan="2" style="padding-left: 4px; padding-bottom: 1px">
                                <ext:TextField ID="CmbNotify2Code_name" runat="server" Cls="text_82px" Width="150px"
                                    TabIndex="7">
                                </ext:TextField>
                            ...
                            <td align="left">
                                <uc1:UserComboBox runat="server" ID="CmbDest" ListWidth="180" clsClass="select_160px"
                                    TabIndex="12" StoreID="StoreLocation" Width="69" winTitle="Location" winUrl="/BasicData/Location/list.aspx?sys=O"
                                    winWidth="845" winHeight="620" Handler="SelectItem('CmbDest','txtDesL')" />
                            </td>
                            <td class="font_11bold" style="padding: 0 5px; text-align: left;" colspan="2">
                                <ext:TextField ID="txtDesL" runat="server" Cls="text_82px" Width="160" TabIndex="12">
                                </ext:TextField>
                            </td>
                        </tr>
                        <tr style="height: 24px;width:624px;">
                        <td colspan="8">
                        <table>
                            <tr>
                              <td width="68" align="left" class="font_11bold" style="padding-left: 0px;padding-bottom:10px;">
                                Remark
                            </td>
                            <td>
                                <ext:TextArea ID="txtMAWBRemark" runat="server" Width="242" Height="25" Cls="text_80px" align="left" 
                                    TabIndex="13">
                                </ext:TextArea>
                            </td>
                            <td colspan="3">
                                ...
                                <table cellpadding="0" cellspacing="0" border="0" width="66">
                                    <tr>
                                        <td class="font_11bold" style="padding-left: 14px; padding-right: 2px;">
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0" border="0" width="70">
                                    <tr>
                                        <td class="font_11bold" style="padding: 0 12px; text-align: left;">
                                            ETA
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <td align="left">
                                <ext:DateField ID="txtArrivalDate" runat="server" Cls="text" Width="90" Format="d/m/Y"
                                    TabIndex="15">
                                </ext:DateField>
                            </td>
                                </tr>
                                ...
                                <table border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td style="display: none;">
                                            <uc1:Autocomplete runat="server" ID="CmbCoLoader" clsClass="input text_82px" TabIndex="8"
                            ...
                            <td align="left" colspan="2" style="padding-left: 4px;">
                                <ext:TextField ID="CmbCoLoader_name" runat="server" Cls="text_82px" Width="150px"
                                    TabIndex="8" Hidden="true">
                                </ext:TextField>
        ...
        <table id="table1" width="800px" border="0" cellpadding="0" cellspacing="0" style="padding-top: 2px;">
            <tr>
            ...
            <tr>
                <td colspan="2">
                    <uc1:Costing ID="ucCost" runat="server" type="M" sys="BK" />
                </td>
            </tr>
            <tr>
