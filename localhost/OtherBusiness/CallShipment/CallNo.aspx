...
<body>
    ...
    <div>
     <ext:Window 
            ...
            <td><table cellpadding="0" cellspacing="0" border="0" width="65px"><tr><td  valign="top" class="font_11px" style="padding-top:4px" >Lot No. #</td></tr></table></td>
            ...
            <td  class="font_11px" style="padding-top:4px; padding-right:2px">Master #</td>
            <td style="padding-top:6px">
            ...
            <td class="font_11px" style="padding-top:4px">House #</td>
            <td style="padding-top:6px">
            ...
            <tr><td colspan="3" style="padding-left:92px; padding-top:5px"><table  cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right:2px;">
