<%@ Page Language="C#" AutoEventWireup="true" CodeFile="List.aspx.cs" Inherits="Triangle_OceanShipment_List" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../OtherJs/TK.js" type="text/javascript"></script>
                        ...
                        <tr>
                            <td>
                                <img src="/images/arrows_btn.png" id="img_showlist" style="cursor: pointer; vertical-align: middle"
                                    alt="View" onclick="createFrom('TK');" />&nbsp;
                            </td>
                            <td>
                                Trucking Shipment
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <%if (!string.IsNullOrEmpty(Request["seed"]))
                                  { %>
                                <uc1:Transfer runat="server" ID="TransferSys" sys="TK" />
                                <%} %>
                            </td>
                        </tr>
                    </table>
    ...
    <div id="mawb_div" runat="server" style="margin-bottom: 30px; margin-top: 70px">
        <table width="950" border="0" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td width="488" rowspan="3" valign="top" style="padding-top: 30px">
                    <div id="div_top" style="margin-top: 115px">
                        <table width="316" height="25" border="0" cellpadding="0" cellspacing="0" class="table_nav2">
                            <tr>
                    ...
                    <table width="318" border="0" cellpadding="0" cellspacing="1" bgcolor="#8DB2E3" class="table"
                        ...
                        <tr>
                            ...
                            <td align="center" bgcolor="#FFFFFF" style="padding-left: 2px; padding-right: 2px;
                                ...
                                <table border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            <ext:NumberField ID="txtGWT" runat="server" Cls="text" DecimalPrecision="2" StyleSpec="text-align:right"
                                                TabIndex="19" Width="90">
                                                <Listeners>
                                                    <Change Handler="if(#{txtGWT}.getValue()!=''){ if(#{txtCBM}.getValue()==''){#{txtCWT}.setValue(#{txtGWT}.getValue()*1.0000/1000)} else{if(#{txtGWT}.getValue()>#{txtCBM}.getValue()*1000){#{txtCWT}.setValue(#{txtGWT}.getValue()*1.0000/1000)}else{#{txtCWT}.setValue(#{txtCBM}.getValue())}} } else { if(#{txtCBM}.getValue()!=''){#{txtCWT}.setValue(#{txtCBM}.getValue())}}" />
                                                </Listeners>
                                            </ext:NumberField>
                                        </td>
                                    </tr>
                        ...
                        <tr>
                            <td align="center" bgcolor="#FFFFFF" class="font_11bold" width="63px">
                                CBM
                            </td>
                            <td align="left" bgcolor="#FFFFFF" style="padding-left: 2px">
                                <table border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            <ext:NumberField ID="txtCBM" runat="server" Cls="text" DecimalPrecision="3" StyleSpec="text-align:right"
                                                TabIndex="20" Width="90">
                                                <Listeners>
                                                    <Change Handler="if(#{txtCBM}.getValue()!=''){if(#{txtGWT}.getValue()==''){#{txtCWT}.setValue(#{txtCBM}.getValue())}else{ if(#{txtGWT}.getValue()>#{txtCBM}.getValue()*1000){#{txtCWT}.setValue(#{txtGWT}.getValue()*1.0000/1000)}else{#{txtCWT}.setValue(#{txtCBM}.getValue())} }} else{ if(#{txtGWT}.getValue()!=''){#{txtCWT}.setValue(#{txtGWT}.getValue()*1.0000/1000)}};#{txtCWT}.focus(true);" />
                                                </Listeners>
                                            </ext:NumberField>
                                        </td>
                                    </tr>
                                ...
                                <td align="center" bgcolor="#FFFFFF" style="padding-left: 2px; padding-right: 2px">
                                    <uc1:UserComboBox runat="server" ID="CmbUnit" ListWidth="180" clsClass="select_160px"
                                        StoreID="StoreUnit" Width="67" winTitle="Unit" TabIndex="23" winUrl="/BasicData/Unit/list.aspx?sys=O"
                        ...
                        <tr>
                            ...
                            <td align="center" bgcolor="#FFFFFF">
                                <table border="0" cellpadding="0" cellspacing="0" align="left" style="padding-left: 2px">
                                    <tr>
                                        <td>
                                            <ext:NumberField ID="txtCWT" runat="server" Cls="text" DecimalPrecision="3" StyleSpec="text-align:right"
                                                TabIndex="21" Width="90">
                                            </ext:NumberField>
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <td align="center" bgcolor="#FFFFFF">
                                    <ext:NumberField ID="txtContainer" runat="server" Cls="text" AllowDecimals="false"
                                        StyleSpec="text-align:right" TabIndex="24" Width="88" Hidden="true">
                                    </ext:NumberField>
                                </td>
                        </tr>
                    </table>
            ...
            <tr>
                <td align="left" valign="top" style="padding-top: 38px; padding-left: 6px; width: 624px">
                    <table width="653px" border="0" cellpadding="0" cellspacing="0" style="margin-top: 8px;">
                        <tr style="height: 24px">
                            <td align="left" valign="middle" style="padding-left: 2px">
                                Master
                            </td>
                            <td align="left" class="font_11px_gray">
                                <ext:TextField ID="txtMAWB" runat="server" Cls="text_82px" Width="108px" TabIndex="1">
                                </ext:TextField>
                            </td>
                            <td align="left" style="width: 44px; text-align: left; padding-left: 0px">
                                House
                            </td>
                            <td align="left" style="padding-left: 2px">
                                <ext:TextField ID="txtHAWB" runat="server" Cls="text_110px" Width="108px" TabIndex="2">
                                    <Listeners>
                                        <Blur Handler="CheckHBLNo(this,'TK',hidSeed.getValue())" />
                                    </Listeners>
                                </ext:TextField>
                            </td>
                            <td class="font_11bold" style="padding-left: 8px; padding-right: 2px;">
                                Sales<span class="font_red" style="padding-left: 16px">*</span>
                            </td>
                            <td align="left" style="padding-right: 8px">
                                <uc1:UserComboBox runat="server" ID="CmbSalesman" TabIndex="3" Query="option=SalesList"
                                    Width="87" clsClass="select_65" StoreID="StoreSalesman" winTitle="Salesman" winUrl="/BasicData/Salesman/list.aspx"
                            ...
                            <td align="left">
                                <ext:DateField ID="txtJob" runat="server" Cls="text" Width="89" Format="d/m/Y" TabIndex="4">
                                </ext:DateField>
                            </td>
                            <td rowspan="6">
                                <table width="5px">
                        ...
                        <tr style="height: 24px">
                            ...
                            <td align="left">
                                <uc1:Autocomplete runat="server" ID="CmbShipperCode" TabIndex="5" Width="81" clsClass="text_82px"
                                    winTitle="Company" winUrl="/BasicData/Customer/detail.aspx" winWidth="800" winHeight="800"
                                    Query="option=CompanyList" isDiplay="false" />
                            </td>
                            <td colspan="2">
                            </td>
                            <td align="left" class="font_11bold" style="padding-left: 8px">
                                Carrier
                            </td>
                            <td colspan="3">
                                <table cellpadding="0" cellspacing="0" border="0">
                                    <tr>
                                        <td>
                                            <uc1:Autocomplete runat="server" ID="CmbCarrierCode" clsClass="input text_82px" TabIndex="13"
                                                Width="81" winTitle="Company" winUrl="/BasicData/Customer/detail.aspx" winWidth="800"
                                                winHeight="800" Query="option=CompanyList" isDiplay="false" />
                                        </td>
                                        <td align="left" style="padding-left: 2px" valign="top">
                                            <ext:TextField ID="CmbCarrierCode_name" runat="server" Cls="text_82px" Width="153"
                                                TabIndex="14">
                                            </ext:TextField>
                        ...
                        <tr>
                            ...
                            <td align="left" colspan="3" style="padding-bottom: 3px; padding-top: 3px">
                                <ext:TextArea ID="CmbShipperCode_name" runat="server" StyleSpec="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:10px; height:25px; width:255px"
                                    TabIndex="6" MaxLength="120">
                                </ext:TextArea>
                            ...
                            <td colspan="3" align="left" valign="middle">
                                <table border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            <ext:ComboBox ID="cmbVesselCode" runat="server" Cls="select" Width="145" StoreID="StoreVessel"
                                                DisplayField="text" TabIndex="15" ValueField="value" Mode="Local" ForceSelection="false"
                                        ...
                                        <td>
                                            <ext:ComboBox ID="cmbVesselText" runat="server" Cls="select" Width="95" StoreID="StoreVoyage"
                                                Editable="true" TabIndex="16" DisplayField="text" ValueField="value" Mode="Local"
                                                ForceSelection="false" TriggerAction="All">
                                            </ext:ComboBox>
                                        </td>
                        ...
                        <tr style="height: 24px">
                                    ...
                                    <tr>
                                        <td align="left">
                                            <uc1:UserComboBox runat="server" ID="CmbDeparture" ListWidth="180" clsClass="select_160px"
                                                TabIndex="7" StoreID="StoreLocation" Width="87px" winTitle="Location" winUrl="/BasicData/Location/list.aspx?sys=O"
                                                winWidth="845" winHeight="620" Handler="SelectItem('CmbDeparture','txtDepL')" />
                                        </td>
                                        <td align="left" style="padding-left: 4px">
                                            <ext:TextField ID="txtDepL" runat="server" Cls="text_82px" Width="151" TabIndex="8">
                                            </ext:TextField>
                                        </td>
                                    </tr>
                                </table>
                                        ...
                                        <td>
                                            <table cellpadding="0" cellspacing="0" border="0">
                                                <tr>
                                                    ...
                                                    <td class="font_red" style="padding-left: 0px; width: 9px;">
                                                        *
                                                    </td>
                                                </tr>
                                            </table>
                            ...
                            <td align="left">
                                <ext:DateField ID="txtDepartDate" runat="server" Cls="text" Width="87" Format="d/m/Y"
                                    TabIndex="17">
                                    <Listeners>
                                        <Change Handler="if(this.getValue()!=''){#{txtJob}.setValue(this.getValue());}" />
                                    </Listeners>
                                </ext:DateField>
                            </td>
                            <td>
                            ...
                            <td>
                                <ext:DateField ID="txtDeliveryDate" runat="server" Cls="text" Width="89" Format="d/m/Y"
                                    TabIndex="17">
                                </ext:DateField>
                            </td>
                        </tr>
                        <tr style="height: 24px">
                            ...
                            <td align="left">
                                <uc1:Autocomplete runat="server" ID="CmbConsigneeCode" Query="option=CompanyList"
                                    TabIndex="9" Width="81" clsClass="text_82px" winTitle="Company" winUrl="/BasicData/Customer/detail.aspx"
                            ...
                            <td align="left" valign="top" style="padding-top: 2px">
                                <ext:TextField ID="txtSO" runat="server" Cls="text_82px" Width="87" MaxLength="20"
                                    TabIndex="18">
                                </ext:TextField>
                            </td>
                            <td colspan="2">
                        ...
                        <tr style="height: 24px">
                            ...
                            <td align="left" colspan="3">
                                <ext:TextArea ID="CmbConsigneeCode_name" runat="server" StyleSpec="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:10px; height:25px; width:255px  "
                                    TabIndex="10" MaxLength="120">
                                </ext:TextArea>
                                <ext:Hidden ID="CmbConsigneeCode1" runat="server">
                                </ext:Hidden>
                            </td>
                            <td width="60" align="left" class="font_11bold" style="padding-left: 8px;" rowspan="2" valign="top">
                                Remark
                            </td>
                            <td colspan="7" rowspan="2">
                                <ext:TextArea ID="txtMAWBRemark" runat="server" Width="263" Height="60" Cls="text_80px" TabIndex="15"  style="magin-top: 5px;">
                                </ext:TextArea>
                            </td>
                        </tr>
                        <tr>
                                    ...
                                    <tr>
                                        <td align="left">
                                            <uc1:UserComboBox runat="server" ID="CmbDest" ListWidth="180" clsClass="select_160px"
                                                TabIndex="11" StoreID="StoreLocation" Width="87" winTitle="Location" winUrl="/BasicData/Location/list.aspx?sys=O"
                                                winWidth="845" winHeight="620" Handler="SelectItem('CmbDest','txtDesL')" />
                                        </td>
                                        <td class="font_11bold" style="text-align: left; padding-left: 4px">
                                            <ext:TextField ID="txtDesL" runat="server" Cls="text_82px" Width="151" TabIndex="12">
                                            </ext:TextField>
                                        </td>
                                    </tr>
                                </table>
        ...
        <table id="table1" width="800px" border="0" cellpadding="0" cellspacing="0" style="padding-top: 8px">
            <tr>
            ...
            <tr id="grid3">
                <td valign="top" id="GridView_2">
                    <table cellpadding="0" cellspacing="0" width="654">
                        ...
                        <tr>
                            <td>
                                <ext:GridPanel ID="gridInvoice" runat="server" Width="654" Height="160" TrackMouseOver="true"
                                    ColumnLines="True">
                                    <Store>
                                    ...
                                    <ColumnModel ID="ColumnModel2">
                                        <Columns>
                                            ...
                                            <ext:Column Header="Bill To" DataIndex="CompanyName" Width="194">
                                            </ext:Column>
                                            <ext:Column Header="Invoice/Credit #" DataIndex="DN_CNNO" Width="120">
                                            </ext:Column>
                                            <ext:Column Header="CUR" DataIndex="Currency" Width="40" Align="Center">
                                            </ext:Column>
                                            <ext:Column Header="Amount" DataIndex="Amount" Width="70" Align="Right">
                                            </ext:Column>
                ...
                <td valign="top" style="padding-left: 5px;">
                    <table width="300" border="0" align="left" cellpadding="0" cellspacing="0" style="display: none;">
                        <tr>
                            <td align="left">
                                <table width="318" border="0" cellpadding="0" cellspacing="0" class="table_nav2">
                                    <tr>
                                ...
                                <table border="0" align="left" cellpadding="0" cellspacing="4" class="select_142px">
                                    ...
                                    <tr>
                                        <td height="0" align="left" style="padding-left: 4px; padding-top: 2px" valign="top"
                                            class="font_11bold">
                                            Company
                                        </td>
                                    ...
                                    <tr>
                                        <td height="0" align="left" style="padding-top: 2px" valign="top">
                                        ...
                                        <td height="0" colspan="3" align="left">
                                            <table cellpadding="0" cellspacing="0" border="0">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input onclick="if(ReturnNull()&&ValidataText()){AddInvoice('OT','CmbCompanyRightCode',CmbCurrencyRight,StoreCurrInvoice,'M')}"
            ...
            <tr>
                <td colspan="2">
                    <uc1:Costing ID="ucCost" runat="server" type="M" sys="TK" />
                </td>
            </tr>
            <tr>
